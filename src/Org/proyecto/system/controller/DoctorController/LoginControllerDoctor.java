...
public class LoginControllerDoctor {
    ...
    public LoginControllerDoctor() {
    }
    public static boolean ValidacionDoc(String username, String pass){
        Connection conn = null;
        try {
            conn = ConexionDB.getConnection(); 
            PreparedStatement stmt = conn.prepareStatement("CALL sp_verificarCredendialesDoc(?,?)");
